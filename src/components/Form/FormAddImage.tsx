...
interface FormAddImageValidations {
...
interface MutationAddImageData {
  title: string;
  description: string;
  url: string;
}
...
export function FormAddImage({ closeModal }: FormAddImageProps): JSX.Element {
  ...
  const formValidations: FormAddImageValidations = {
    image: {
  ...
  const mutation = useMutation(
    (data: MutationAddImageData) => api.post('api/images', data),
    {
